        ...
        <div style="margin-top: 10px">
            <div style="display: flex;justify-content: space-between">
                <div>
                    <el-input style="width: 350px"
                              :disabled="showAdvanceSearchView" placeholder="请输入员工名进行搜索，可以直接回车搜索..."
                              v-model="keywords"
                              clearable
                              @clear="initEmps"
                              prefix-icon="el-icon-search"
                              @keydown.enter.native="initEmps"></el-input>
                    <el-button style="margin-left: 10px" :disabled="showAdvanceSearchView"
                               icon="el-icon-search" type="primary" @click="initEmps">
                        搜索
                    </el-button>
                ...
                <div>
                    ...
                    <el-button type="danger" icon="el-icon-delete" @click="deleteEmpByIds"
            ...
            <div v-show="showAdvanceSearchView"
                ...
                <el-row>
                    ...
                    <el-col :span="4">
                        职位:
                        <el-select v-model="searchValue.posId" placeholder="职位" size="mini" style="width: 130px;" clearable>
                            <el-option
                    ...
                    <el-col :span="4">
                        职称:
                        <el-select v-model="searchValue.jobLevelId" placeholder="职称" size="mini" clearable
                                   style="width: 130px;">
                            <el-option
        ...
        <div style="margin-top: 10px">
            <el-table
                ...
                <el-table-column
                        ...
                        label="操作">
                    <template slot-scope="scope">
                        <el-button @click="showEditDialog(scope.row)" style="padding: 3px" size="mini" type="text">编辑</el-button>
                        <el-button style="padding: 3px" size="mini" type="primary">查看高级资料</el-button>
                        <el-button @click="deleteEmployee(scope.row)" style="padding: 3px" size="mini" type="danger">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            <div>
...
<script>
    export default {
        ...
        methods: {
            ...
            deleteEmpByIds(){
                this.$confirm('此操作将永久删除' +this.multipleSelection.length+ '条员工信息, 是否继续?', '提示', {
            ...
            initPositons(){
                this.getRequest("/employee/basic/positons").then(resp=>{
                    if (resp){
                        this.positons=resp;
                    }
                })
