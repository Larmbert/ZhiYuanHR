            ...
            <el-card class="hr-card" v-for="(hr,index) in hrs" :key="index">
                ...
                <div>
                    ...
                    <div class="userinfo-container">
                        ...
                        <div>用户角色：<el-tag type="success" style="margin-left: 4px"
                        v-for="(role,indexr) in hr.roles" :key="indexr">{{role.nameZh}}</el-tag>
                            <el-popover
                                    placement="right"
                                    title="角色列表"
                                    width="200"
                                ...
                                <el-button slot="reference" type="text" icon="el-icon-more" style="margin-left: 4px"></el-button>
                            </el-popover>
                        </div>
