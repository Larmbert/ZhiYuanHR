...
public class PoiUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //获取文档信息
        DocumentSummaryInformation docIfo=workbook.getDocumentSummaryInformation();
        //文档类别
        docIfo.setCategory("员工信息");
        //文档管理员
        docIfo.setManager("Light");
        //设置公司信息
        docIfo.setCompany("www.light.com");
        //创建摘要信息
        SummaryInformation sumInfo=workbook.getSummaryInformation();
        sumInfo.setTitle("员工信息表");
        sumInfo.setAuthor("Light");
        sumInfo.setComments("本文档由Light提供");
        //创建样式
        //创建标题行样式
        ...
        try {
            headers.setContentDispositionFormData("attachmnet",new String("员工表.xls".getBytes("UTF-8"),"ISO-8859-1"));
